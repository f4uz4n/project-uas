...
$routes->group('api/auth', function ($routes) {
    ...
    $routes->post('refresh', 'AuthController::refresh', ['filter' => 'jwt']); // Bug #1 fixed
});

// User routes - Bug #2 fixed: Added 'api/' prefix
...
// Task routes - Bug #3 fixed: Changed filter from 'auth' to 'jwt'
